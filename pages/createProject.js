...
function CreateGig() {
  ...
  try {
    ...
    let result = await fetch(
      `https://distributed.town:30005/api/gig`,
      {
        method: "POST",
        headers: new Headers({
      ...
      <form className="border-l-2 flex flex-col pl-4">
        <div className="flex flex-col">
          <div className="flex justify-between">
            <label className="font-bold  text-xl underline" htmlFor="gigTitle">Project Title</label>
            <p className="text-dove-gray">Hint: a short, clear title will catch contributors’ attention. Just be honest please.</p>
          </div>
        ...
        <div className="flex flex-col">
          <div className="flex justify-between">
            <label className="font-bold  text-xl underline" htmlFor="gigDesciption">Project Description</label>
            <p className="text-dove-gray">
            Hint: whether you want to build a dApp, or launch a new Art event - your community can help to make it happen! Be clear in the description, and assign the right tasks!            </p>
          </div>
      ...
      <div className="flex flex-wrap w-full">
        ...
        <div className="flex flex-col sm:w-1/2 lg:w-1/3 space-y-2 p-2">
          <div className="flex flex-col flex-1 px-10 py-12" >
            ...
            <h2 className="text-dove-gray">Hint: If the Project requires skills not available in the community, just <span className="text-denim underline">Send a Signal</span> to attract more talent.
             </h2>
            </div>  
        ...
        <div className="flex flex-col sm:w-1/2 lg:w-1/3 space-y-2 p-2">
          <div className="flex flex-col flex-1 px-10 py-12" >
            ...
            <h2 className="text-dove-gray">Hint: the effort to complete this Project. This value influences the Funds needed in your <span className="text-denim underline">Community Treasury</span>!
            </h2>
            </div>  
        ...
        <div className="flex flex-col sm:w-1/2 lg:w-1/3 space-y-2 p-2">
          <div className="flex flex-col flex-1 px-10 py-12" >
            <div className="flex-1 mb-12">
              ...
              <h2 className="text-dove-gray">Hint: the amount funds needed.
              </h2>
            </div>  
