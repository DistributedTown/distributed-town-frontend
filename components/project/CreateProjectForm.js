...
const CreateProjectForm = ({
  ...
  return (
    <form
      className="border-l-2 border-denim flex flex-col p-2 mt-6 mb-24"
    ...
    >
      ...
      <div className="flex flex-col">
        <div className="flex justify-between">
          ...
          <p className="text-dove-gray">
            Hint: whether you want to build a dApp, or launch a new Art event -
            your community can help to make it happen! Be clear in the
            description, and assign the right tasks!
          </p>
        </div>
        <textarea
      ...
      <div className="flex">
        <div className="p-2">
          <div className="px-10 py-12">
            ...
            <h2 className="text-dove-gray">
              ...
              community, just send a signal to attract more talent.
            </h2>
        ...
        <div className="p-2">
          <div className="px-10 py-12">
            ...
            <h2 className="text-dove-gray">
              Hint: the effort needed to complete this Project. This value
              influences the Funds needed in your Community Treasury!
            </h2>
            <input
              id="commitment"
              name="commitment"
      ...
      {creationState === undefined ? (
        ...
        <p>Can't create project, community is not yet active</p>
      ) : (
