       ...
       <div className="flex flex-col border-l-2 border-denim p-2">
        ...
        <form className="border-l-2 flex flex-col pl-4">
          <div className="flex flex-col">
            ...
            <input className="border border-dove-gray py-1 px-2 " id="title" onChange={handleChange} />
          ...
          <div className="flex flex-col">
            ...
            <input className="border border-dove-gray py-6 px-2" id="description" onChange={handleChange} />
          </div>
        </form>
        ...
        <div className="flex fleox-row w-full p-8">
          ...
          <div className="flex flex-col w-1/3 space-y-2 p-2">
            ...
            <div className="grid grid-cols border-2 border-denim p-2">
