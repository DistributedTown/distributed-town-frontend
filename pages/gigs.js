   ...
   // const signal = abortController.signal;
    ...
    async function effect() {
      ...
      try{
          ...
          let resFetchGigs = await fetch(`https://distributed.town:30005/api/gig?isOpen=true`, {
            method: "GET",
            headers: new Headers({
          ...
          if(userInfo.skills === null || typeof userInfo.skills === 'undefined'){
            let reresFetchUsers = await fetch(`https://distributed.town:30005/api/user/login`, {
              method: "POST",
              headers: new Headers({
                Authorization: "Bearer " + token,
              }),
...
const takeGig = async (gigID) => {
  try{
    let result = await fetch(`https://distributed.town:30005/api/gig/${gigID}/accept`, {
      method: "POST",
      headers: new Headers({
        Authorization: "Bearer " + token,
      }),
