...
const CommunityTreasuryForm = ({ register, errors, apy, availableDAI, handleSubmit, onSubmit, stakingStage }) => {
                ...
                <div className="flex">
                    <div className="flex flex-col w-1/2 p-3">
                        ...
                        <div className="flex justify-around">
                            <div>
                                <input name="currency" type="radio" value="DAI" id="DAI" ref={register({ required: true })} />
                                <label className="font-bold pl-3" for="DAI">DAI</label>
                            </div>
                            <div>
                                <input name="currency" type="radio" value="USDC" id="USDC" ref={register({ required: true })} />
                                <label className="font-bold pl-3" for="USDC">USDC</label>
                            </div>
                        </div>
                        {errors.currency && <p className="text-red-600">Please select stablecoin to stake</p>}
